...
public class DisguisePlayerHandler {
    ...
    public static EntityType<?> getPerceivedEntityType(Entity entity) {
        if (entity instanceof PlayerEntity) {
            ...
            if (standPower != null && standPower.getStandManifestation() instanceof YellowTemperanceEntity) {
                ...
                if (stand.isUserDisguised() && stand.getUserDisguiseEntity().isPresent()) {
                    return stand.getUserDisguiseEntity().get();
                }
            }
        }
