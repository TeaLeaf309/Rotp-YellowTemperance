...
import com.TheChaYe.rotp_yellowtemperance.client.render.stand.KhnumRenderer;
import com.TheChaYe.rotp_yellowtemperance.client.render.stand.YellowTemperanceRenderer;
...
public class ClientInit {
    ...
    public static void onFMLClientSetup(FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                AddonStands.KHNUM.getEntityType(),
                KhnumRenderer::new
        );
        RenderingRegistry.registerEntityRenderingHandler(
                InitStands.STAND_KHNUM.getEntityType(),
                KhnumRenderer::new
        );
