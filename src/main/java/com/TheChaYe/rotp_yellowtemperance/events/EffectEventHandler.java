...
public class EffectEventHandler {
    ...
    public static void onLivingUpdate(LivingEvent.LivingUpdateEvent event) {
        ...
        YellowTemperanceConfig.Common config = YellowTemperanceConfig.getCommonConfigInstance(entity.level.isClientSide());
        int triggerTicks = config.erosionTriggerTicks.get();
        int resetDuration = config.erosionResetDuration.get();
        int fireResetDuration = config.erosionFireResetDuration.get();
        int maxLevel = config.erosionMaxLevel.get();
