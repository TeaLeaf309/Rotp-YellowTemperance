...
public class Disguise extends StandEntityAction {
    /**
     * 构造函数 / Constructor
     *
     * @param builder 动作构建器 / Action builder
     */
    public Disguise(Builder builder) {
        super(builder);
    }
    ...
    public static void onPlayerDisguisedServer(ServerPlayerEntity player, StandEntity stand) {
        ...
        player.getServer().execute(() -> {
            ServerDisguiseHandler.updatePlayerPhysicsOnServer(player);
        });
